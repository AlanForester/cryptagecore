...
- [Pub/Sub](http://godoc.org/redis.v4#PubSub).
- [Transactions](http://godoc.org/redis.v4#Multi).
- [Pipelining](http://godoc.org/redis.v4#Client.Pipeline).
- [Scripting](http://godoc.org/redis.v4#Script).
- [Timeouts](http://godoc.org/redis.v4#Options).
- [Redis Sentinel](http://godoc.org/redis.v4#NewFailoverClient).
- [Redis Cluster](http://godoc.org/redis.v4#NewClusterClient).
- [Ring](http://godoc.org/redis.v4#NewRing).
- [Cache friendly](https://github.com/go-redis/cache).
- [Rate limiting](https://github.com/go-redis/rate).
- [Distributed Locks](https://github.com/bsm/redis-lock).

API docs: http://godoc.org/redis.v4.
Examples: http://godoc.org/redis.v4#pkg-examples.
...
Please go through [examples](http://godoc.org/redis.v4#pkg-examples) to get an idea how to use this package.
